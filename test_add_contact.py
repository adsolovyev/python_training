...
class TestAddGroup(unittest.TestCase):
    ...
    def test_add_group(self):
        ...
        self.add_email2(wd)
        self.add_email3(wd)
        self.add_homepage(wd)
        self.add_birthday_info(wd)
        self.add_aniversary_info(wd)
        self.add_second_address(wd)
        self.add_second_phone(wd)
        self.add_notes(wd)
