...
class TestAddGroup(unittest.TestCase):
    ...
    def test_add_contact_short_form(self):
        ...
        self.login(wd, username="admin", password="secret")
        self.open_add_new_page(wd)
        self.add_firstname_middlename_lastname(wd, Fullname(name="name_002", middlename="middlename_002", lastname="lastname_002"))
        self.add_nickname(wd, nickname="test_short_nickname")
        self.add_email(wd, email="email@1.short")
        self.add_birthday_info(wd)
        self.submit_new_contact(wd)
        self.go_to_home_page(wd)
        self.logout(wd)
